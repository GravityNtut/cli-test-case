...
Scenario:
    ...
    #Scenario
    Scenario: Success scenario for list of data products
    ...
    Examples:
        ...
        |  M(2) | drink       |   [null]    | [true]  | 1             | 1           | 100           | 
        |  M(3) | drink       |   [space]   | [true]  | 1             | 100         | 1             | 
        |  M(4) | drink       |  [a]x32768  | [true]  | 0             | 0           | 1             |

#Scenario
    Scenario: Fail scenario for list of data products
    When Listing all data products using gravity-cli
