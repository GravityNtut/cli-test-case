...
../gravity-cli product ruleset add drink drinkCreated3 \
    --enabled \
    --event=drinkCreated3 --method=create \
    --schema="./assets/schema.json" \
    --handler="./assets/extraColumn.js" \
	--pk=id
...
../gravity-cli pub drinkCreated '{"id":1,"name":"hgdhd","price":100,"kcal":50}'
../gravity-cli pub drinkCreated2 '{"id":2,"name":"hgdhd","price":100,"kcal":50}'
../gravity-cli pub drinkCreated3 '{"id":3,"name":"hgdhd","price":100,"kcal":50}'
../gravity-cli pub drinkCreated '{"id":1,"name":"ddd"}'
