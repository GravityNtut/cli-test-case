...
#Scenario
    ...
    Examples:
        ...
        |  M(31) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schemaWrongType.json     | id       | [true]    | [true]    |
        |  M(32) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schema.json              | id,uid   | [true]    | [true]    |
        |  M(33) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schema.json              | id,      | [true]    | [true]    |
        |  M(34) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schema.json              | id       | [false]   | [false]   |
    ...
    Examples:
        ...
        |  E3(12) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |                                                    |          ./assets/schema.json       |    id      |  [true]   |      [true]     |
        |  E3(13) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/WrongFileExtension.txt               |          ./assets/schema.json       |    id      |  [true]   |      [true]     |
        |  E3(14) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/WrongFileExtensionAndFormat.jpg      |          ./assets/schema.json       |    id      |  [true]   |      [true]     |
        |  E3(15) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/handler.js                           |          ./assets/schema.json       |    ""      |  [true]   |      [true]     |
        |  E3(16) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/handler.js                           |          ./assets/schema.json       |    " "     |  [true]   |      [true]     |
        |  E3(17) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/handler.js                           |          ./assets/schema.json       |  _-*($)?@  |  [true]   |      [true]     |
        |  E3(18) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/handler.js                           |          ./assets/schema.json       |    id      |  [false]  |      [true]     |
        |  E3(19) | drinkEvent   | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' |  create  |      ./assets/handler.js                           |          ./assets/schema.json       |    id      |  [true]   |      [false]    |
        |  E3(20) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schemaWithNoPK.json      | id       | [true]    | [true]    |
        |  E3(21) | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | create   | ./assets/handler.js     | ./assets/schemaWithEmptyJson.json | id       | [true]    | [true]    |
    ...
    Examples:
        ...
        |  E5(1)  | drinkEvent | '{"id":1,"uid":1,"name":"test","price":100,"kcal":50}' | '{"id":1,"uid":1,"name":"test"}' |  create  |      assets/handler.js      |          assets/schema.json       |    id      |  [true]   |      [true]     |