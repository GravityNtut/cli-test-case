...
#Scenario
	...
	| M(1) | drink       | [ignore]     |		[ignore]   		| [ignore]  |
	| M(2) | drink       | description  |		[ignore] 		| [ignore]  |
	| M(3) | drink       | ""  			|		[ignore]   		| [ignore]  |
	| M(4) | drink       | " "    	    |	    [ignore]   	    | [ignore]  |
	| M(5) | drink       | [ignore]     | ./assets/schema.json  | [ignore]  |
	| M(6) | drink       | [ignore]     |		[ignore]		| [true]    |
	| M(7) | drink       |  description | ./assets/schema.json  | [true]    |
