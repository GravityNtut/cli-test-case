...
#Scenario
	...
	Then ruleset 更改成功
	And 使用nats驗證 data product "<ProductName>" 的 ruleset "<Ruleset>" 更改成功 "<Method>" "<Event>" "<Pk>" "<Desc>" "<Handler_script>" "<Schema>" "<Enabled>"
	Examples:
    ...
    | drink       | drinkCreated  | [ignore]  | [ignore]      | [ignore] | [ignore]      | handler.js       | [ignore]      | [ignore] |
    | drink       | drinkCreated  | [ignore]  | [ignore]      | [ignore] | [ignore]      | [ignore]         | schema.json   | [ignore] |
    | drink       | drinkCreated  | [ignore]  | [ignore]      | [ignore] | [ignore]      | [ignore]         | [ignore]      | [true]   |

#Scenario
	Scenario: 針對更新data product ruleset失敗情境(不存在的data product/ruleset)
	Given 已有data product "drink"
    Given 已有data product 的 ruleset "drink" "drinkCreated" 
    ...
    | NotExists   | drinkCreated  | create    | drinkCreated  | id       | description   | handler.js       | schema.json      | [true]   |               |
	| drink       | NotExists     | create    | drinkCreated  | id       | description   | handler.js       | schema.json      | [true]   |               |
...
#Scenario
	...
	Then ruleset 更改失敗
	And 應有錯誤訊息 "<Error_message>"
	And 使用nats驗證 data product "<ProductName>" 的 ruleset "<Ruleset>" 資料無任何改動 "<Method>" "<Event>" "<Pk>" "<Desc>" "<Handler_script>" "<Schema>" "<Enabled>"
	Examples:
    | ProductName | Ruleset       | Method    | Event         | Pk       | Desc          | Handler_script   | Schema           | Enabled  | Error_message |
    ...
    | drink       | drinkCreated  | [ignore]  | [ignore]      | [ignore] | [ignore]      | [ignore]         | fail_schena.json | [ignore] |               |